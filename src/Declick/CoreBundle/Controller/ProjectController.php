...
class ProjectController extends DeclickController {
    ...
    public function showAction($projectId) {
        ...
        if ($manager->isExercise($project)) {
            ...
            return $this->forward('DeclickCoreBundle:Exercise:show', array('exerciseId'  => $projectId));
        }
        ...
        return $this->renderContent('DeclickCoreBundle:Project:show.html.twig', 'project', $params);
    }
    ...
    public function editAction($projectId) {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('declick_project_show', array('projectId' => $project->getId())));                
            }
        }
        if (isset($form->attr)) {
        ...
        return $this->renderContent('DeclickCoreBundle:Project:edit.html.twig', 'project', array('form' => $form->createView(), 'title'=>'project.edition'));
    }
    ...
    public function publishedAction(Request $request) {
        ...
        return $this->renderContent('DeclickCoreBundle:Project:published.html.twig', 'discover', array('page' => $page, 'search' => $search, 'paginationRoute' => 'declick_project_published_list'));
    }

    public function getPublishedAction(Request $request) {
        if (!$request->isXmlHttpRequest()) {
            $this->redirect($this->generateUrl('declick_project_published'));
        }
        $pagination = $this->get('declick_core.pagination')->paginate($request, "admin_users", 'DeclickCoreBundle:Project',array('published'=>true));
        return $this->render('DeclickCoreBundle:Project:published_list.html.twig', array('projects' => $pagination));
    ...
    public function executeAction($projectId) {
        ...
        $declickClient = $baseUrl.$this->container->getParameter('declick_core.settings.directory.client')."/execute.html";
        $params['client'] = $declickClient;
        return $this->render('DeclickCoreBundle:Project:execute.html.twig', $params);
    ...
    public function listAction() {
        ...
        return $this->renderContent('DeclickCoreBundle:Project:list.html.twig', 'project', $params);
    }
    ...
    public function createAction(Request $request ){        
        ...
        if (!$this->isUserLogged()) {
            ...
            return $this->renderContent('DeclickCoreBundle:Project:edit.html.twig', 'project', array('form' => $form->createView(), 'title'=>'project.creation'));
