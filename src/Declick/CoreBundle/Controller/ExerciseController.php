...
class ExerciseController extends DeclickController {
    ...
    public function showAction($exerciseId,Request $request) {
        ...
        return $this->renderContent('DeclickCoreBundle:Exercise:show.html.twig', 'profile', $params);
    }
    ...
    public function createAction(Request $request ){
        ...
        if ($request->isMethod('POST')){
            ...
            if ($form->isValid()){
                ...
                return $this->redirect($this->generateUrl('declick_exercise_show', array('exerciseId'=>$exercise->getId())));
            }
        }
        return $this->renderContent('DeclickCoreBundle:Exercise:edit.html.twig', 'learn', array('form' => $form->createView(), 'title'=>'exercise.creation'));
    }
    ...
    public function editAction($exerciseId, Request $request) {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('declick_exercise_show', array('exerciseId' => $exerciseId)));                
            }
        }
        if (isset($form->attr)) {
        ...
        return $this->renderContent('DeclickCoreBundle:Exercise:edit.html.twig', 'profile', array('form' => $form->createView(), 'title'=>'exercise.edition'));
    }
    ...
    public function deleteAction($exerciseId, Request $request) {
        ...
        return $this->redirect($this->generateUrl('declick_admin_exercises'));
    }
    ...
    public function listAction() {
        ...
        return $this->renderContent('DeclickCoreBundle:Exercise:list.html.twig', 'project', array('exercises'=>$exercises));        
    }
