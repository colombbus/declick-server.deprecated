<?php
namespace Declick\CoreBundle\Handler;
...
class AuthenticationHandler implements AuthenticationSuccessHandlerInterface, AuthenticationFailureHandlerInterface
{
    ...
    public function onAuthenticationSuccess( Request $request, TokenInterface $token ) {
        ...
        if ( $request->isXmlHttpRequest() ) {
            ...
            $content = $this->templating->render('DeclickCoreBundle:User:menu.html.twig', array('current_project'=>$project));
        ...
        // if form login
            ...
            if ( $this->session->get('_security.main.target_path') ) {
                ...
                $url = $this->router->generate( 'declick_core_homepage' );
            }
    ...
    public function onAuthenticationFailure( Request $request, AuthenticationException $exception ) {
        ...
        if ( $request->isXmlHttpRequest() ) {
            $jsonResponse = new JsonResponse();
            $content = $this->templating->render('DeclickCoreBundle:User:menu.html.twig', array('error' => true));
