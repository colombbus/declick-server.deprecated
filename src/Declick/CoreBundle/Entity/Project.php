...
/**
 * Project
 * @ORM\Entity(repositoryClass="Declick\CoreBundle\Entity\ProjectRepository")
...
class Project {
     ...
     * Set owner
     *
     * @param \Declick\CoreBundle\Entity\User $owner
     * @return Project
     */
    public function setOwner(\Declick\CoreBundle\Entity\User $owner = null)
    {
        $this->owner = $owner;
     ...
     * Get owner
     *
     * @return \Declick\CoreBundle\Entity\User 
     */
     ...
     * Set launcher
     *
     * @param \Declick\CoreBundle\Entity\File $launcher
     * @return Project
     */
    public function setLauncher(\Declick\CoreBundle\Entity\File $launcher = null)
    {
     ...
     * Get launcher
     *
     * @return \Declick\CoreBundle\Entity\File 
     */
     ...
     * Add files
     *
     * @param \Declick\CoreBundle\Entity\File $files
     * @return Project
     */
    public function addFile(\Declick\CoreBundle\Entity\File $files)
    {
        $this->files[] = $files;
     ...
     * @param \Declick\CoreBundle\Entity\File $files
     */
    public function removeFile(\Declick\CoreBundle\Entity\File $files)
    {
