...
class ProjectManager extends BaseManager {
    ...
    public function getProjectFile(Project $project, $fileName, $program=false) {
        $qb = $this->em->getRepository('DeclickCoreBundle:File')->createQueryBuilder('a')
    ...
    public function getRepository() {
        return $this->em->getRepository('DeclickCoreBundle:Project');
    }
    
    public function getAllResources(Project $project) {
        return $this->em->getRepository('DeclickCoreBundle:File')->getAllProjectResources($project);        
    }
    
    public function getAllPrograms(Project $project) {
        return $this->em->getRepository('DeclickCoreBundle:File')->getAllProjectPrograms($project);        
    }
    
    public function delete(Project $project) {
        // delete files
        $files = $this->em->getRepository('DeclickCoreBundle:File')->getAllProjectFiles($project);
